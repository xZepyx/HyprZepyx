    ...
    contentItem: Loader {
        ...
        sourceComponent: Item {
            ...
            RowLayout {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        color: appIsActive ? Appearance.colors.colAccent : ColorUtils.transparentize(Appearance.colors.colOnLayer0, 0.5)
                        border.width: appIsActive ? 0 : 1
            ...
            MouseArea {
                anchors.fill: parent
                hoverEnabled: true
                onEntered: iconImageLoader.layer.effect.radius = 12
                onExited: iconImageLoader.layer.effect.radius = 8
            }
        }
    }
}
