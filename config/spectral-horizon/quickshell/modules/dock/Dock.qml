            ...
            MouseArea {
                ...
                Item {
                    ...
                    Item { // Wrapper for the dock background
                        ...
                        color: Qt.rgba(20/255,22/255,25/255,0.95)  // darker translucent background
                        border.width: 1
                        border.color: Qt.rgba(255,255,255,0.08)   // faint border
                        radius: 20         
                        }
                            ...
                            VerticalButtonGroup {
                                ...
                                GroupButton {
                                    ...
                                    contentItem: MaterialSymbol {
                                        ...
                                        color: root.pinned ? Appearance.m3colors.m3onPrimary : "#aaa"
                                    }
                                }
                            }
                            DockSeparator {}
