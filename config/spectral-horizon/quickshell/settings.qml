...
ApplicationWindow {
    ...
    visible: true
    onClosing: Qt.quit()
    title: "Spectral-Horizon Settings"
            ...
            Item {
                ...
                NavigationRail { // Window content with navigation rail and content pane
                    ...
                    FloatingActionButton {
                        ...
                        onClicked: {
                            Qt.openUrlExternally(`${Directories.config}/spectral-horizon/config.json`);
                        }

                        StyledToolTip {
                            content: Translation.tr("Open the shell config file.\nIf the button doesn't work or doesn't open in your favorite editor,\nyou can manually open ~/.config/spectral-horizon/config.json")
                        }
                    }
